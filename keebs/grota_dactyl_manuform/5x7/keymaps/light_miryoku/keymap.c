...
// clang-format off
// HOLDSX, DX: MOUSE, numpad?, SYM1?
// HOLDDX, SX: MEDIA?  SYM2?
// SYM2: : ! @ # $ % ^ &  * _+
...
//                                                        └──────┴─────────┘   └──────┴──────┘                                                    
  ...
  KC_NO , KC_NO        , KC_NO        , KC_NO        ,                                                                                    KC_PGDN      , KC_PGUP      , KC_NO        , KC_NO,
...
//                              └─────┴───┘   └───┴───┘                                               
  ...
  KC_NO , KC_PERCENT , KC_CIRC  , KC_DOLLAR , KC_ASTR   , KC_NO  , KC_NO ,     KC_NO , KC_NO     , TD(TD_DEF_L_BASE) , TD(TD_DEF_L_SYM2) , TD(TD_DEF_L_SYM1) , KC_NO   , EE_CLR ,
  KC_NO , KC_PIPE    , KC_EQUAL , KC_COLON  , KC_DQUO   , KC_NO  , KC_NO ,     KC_NO , KC_NO     , KC_RCTL           , KC_RSFT           , KC_LALT           , KC_RGUI , KC_NO  ,
  KC_NO , KC_SLASH   , KC_UNDS  , KC_DOT    , KC_ORIGIN , KC_NO  , KC_NO ,     KC_NO , KC_NO     , KC_RALT           , KC_NO             , KC_NO             , KC_NO   , KC_NO  ,
...
//    │  │      │           │           │           │   │   │   │   │     │      │      │       │     │   │
//    ├───┼──────┼───────────┼───────────┼───────────┼───┼───┤   ├───┼─────┼──────┼──────┼───────┼─────┼───┤
//    │ 󰘚 │      │ TD(def ) │ TD(def ) │ TD(def ) │   │   │   │   │     │ 7 F7 │ 8 F8 │ 9 F9  │ / ? │   │
//    ├───┼──────┼───────────┼───────────┼───────────┼───┼───┤   ├───┼─────┼──────┼──────┼───────┼─────┼───┤
...
//                                                   └───┴───┘   └───┴─────┘                                
  ...
  KC_NO   , KC_NO   , KC_NO              , KC_ESC              ,                                                                           KC_ESC , KC_C_0 , KC_PLUS  , KC_NO,
...
//    │   │       │       │  󰖁  │    │     │   │   │   │   │           │           │           │   │  │
//    ├───┼───────┼───────┼─────┼─────┼─────┼───┤   ├───┼───┼───────────┼───────────┼───────────┼───┼───┤
//    │   │  󰚱   │  󰚱 ↓  │ 󰚱 ↑ │ 󰚱  │     │   │   │   │   │ TD(def ) │ TD(def ) │ TD(def ) │   │ 󰘚 │
//    ├───┼───────┼───────┼─────┼─────┼─────┼───┤   ├───┼───┼───────────┼───────────┼───────────┼───┼───┤
//    │   │  ←/→ │  / │   │   │     │   │   │   │   │           │   LSFT    │           │   │   │
//    ├───┼───────┼───────┼─────┼─────┼─────┼───┤   ├───┼───┼───────────┼───────────┼───────────┼───┼───┤
//    │   │      │      │  ﱜ  │  ﱛ  │     │   │   │   │   │           │           │           │   │   │
...
//                                    └─────┴───┘   └───┴───┘                                            
  ...
  KC_NO , KC_PRNT_HPT , HF_DWLD , HF_DWLU  , HF_TOGG , KC_NO  , KC_NO ,     KC_NO , KC_NO     , TD(TD_DEF_L_BASE) , TD(TD_DEF_L_MEDIA) , TD(TD_DEF_L_MOUSE) , KC_NO , EE_CLR ,
