...
//                                                   └───┴───┘   └───┴─────┘                        
  ...
  KC_NO , KC_NO   , TD(TD_DEF_L_NUMBERS) , TD(TD_DEF_L_SYM) , TD(TD_DEF_L_BASE) , KC_NO     , KC_NO ,     KC_NO , KC_NO    , KC_LCBR  , KC_GRAVE , KC_BACKSLASH , KC_RCBR , KC_NO,
  KC_NO , KC_LGUI , KC_LALT              , KC_LCTL          , KC_LSFT           , KC_NO     , KC_NO ,     KC_NO , KC_NO    , KC_LPRN  , KC_COMMA , KC_DOT       , KC_RPRN , KC_NO,
  KC_NO , KC_NO   , TD(TD_EE_CLR)        , TD(TD_BOOT)      , KC_NO             , KC_NO     , KC_NO ,     KC_NO , KC_NO    , KC_LBRC  , KC_MINUS , KC_SLASH     , KC_RBRC , KC_NO,
...
//    │   │ LGUI │   LALT    │   LCTL    │   LSFT    │   │   │   │   │        │    ←    │    ↓    │    ↑    │    →    │   │
//    ├───┼──────┼───────────┼───────────┼───────────┼───┼───┤   ├───┼────────┼──────────┼──────────┼──────────┼──────────┼───┤
//    │   │      │   TD(󰘚)   │   TD(󰍛)   │           │   │   │   │   │        │  WHEEL← │  WHEEL↓ │  WHEEL↑ │  WHEEL→ │   │
//    ├───┼──────┼───────────┼───────────┼───────────┴───┴───┘   └───┴────────┴──────────┼──────────┼──────────┼──────────┼───┤
//    │   │      │           │          │                                               │         │          │          │   │
//    └───┴──────┴───────────┴───────────┼───────────┬───┐           ┌────────┬──────────┼──────────┴──────────┴──────────┴───┘
//                                       │     󰭃     │   │           │  BTN2 │   BTN1  │                                     
...
//                                                   └───┴───┘   └───┴────────┘                                                
  KC_NO , KC_NO   , KC_NO              , KC_NO              , KC_NO             , KC_NO , KC_NO ,     KC_NO , KC_NO      , KC_NO      , KC_NO        , KC_NO    , KC_NO       , KC_NO,
  KC_NO , KC_NO   , TD(TD_DEF_L_MEDIA) , TD(TD_DEF_L_MOUSE) , TD(TD_DEF_L_BASE) , KC_NO , KC_NO ,     KC_NO , KC_NO      , KC_LEFT    , KC_DOWN      , KC_UP    , KC_RIGHT    , KC_NO,
  KC_NO , KC_LGUI , KC_LALT            , KC_LCTL            , KC_LSFT           , KC_NO , KC_NO ,     KC_NO , KC_NO      , KC_MS_LEFT , KC_MS_DOWN   , KC_MS_UP , KC_MS_RIGHT , KC_NO,
  KC_NO , KC_NO   , TD(TD_EE_CLR)      , TD(TD_BOOT)        , KC_NO             , KC_NO , KC_NO ,     KC_NO , KC_NO      , KC_WH_L    , KC_WH_D      , KC_WH_U  , KC_WH_R     , KC_NO,
...
//    │   │      │      │      │       │     │   │   │   │   │           │           │           │      │   │
//    ├───┼──────┼──────┼──────┼───────┼─────┼───┤   ├───┼───┼───────────┼───────────┼───────────┼──────┼───┤
//    │   │ 7 F7 │ 8 F8 │ 9 F9 │ 0 F10 │     │   │   │   │   │ TD(def_󰄮) │ TD(def_) │ TD(def_) │      │   │
//    ├───┼──────┼──────┼──────┼───────┼─────┼───┤   ├───┼───┼───────────┼───────────┼───────────┼──────┼───┤
//    │   │ 4 F4 │ 5 F5 │ 6 F6 │  = +  │     │   │   │   │   │   LSFT    │   RCTL    │   LALT    │ RGUI │   │
//    ├───┼──────┼──────┼──────┼───────┼─────┼───┤   ├───┼───┼───────────┼───────────┼───────────┼──────┼───┤
//    │   │  1   │  2   │  3   │       │     │   │   │   │   │  AltrGr   │   TD(󰍛)   │   TD(󰘚)   │      │   │
//    ├───┼──────┼──────┼──────┼───────┴─────┴───┘   └───┴───┴───────────┼───────────┼───────────┼──────┼───┤
//    │   │      │      │  ⏎   │                                         │     ⏎     │           │      │   │
//    └───┴──────┴──────┴──────┼───────┬─────┐           ┌───┬───────────┼───────────┴───────────┴──────┴───┘
//                             │      │    │           │ 󰭃 │           │                                   
...
//                                     └─────┴───┘   └───┴───┘                                               
  KC_NO , KC_NO  , KC_NO  , KC_NO    , KC_NO    , KC_NO  , KC_NO ,     KC_NO , KC_NO     , KC_NO             , KC_NO                , KC_NO            , KC_NO   , KC_NO,
  KC_NO , KC_C_7 , KC_C_8 , KC_C_9   , KC_C_0   , KC_NO  , KC_NO ,     KC_NO , KC_NO     , TD(TD_DEF_L_BASE) , TD(TD_DEF_L_NUMBERS) , TD(TD_DEF_L_SYM) , KC_NO   , KC_NO,
  KC_NO , KC_C_4 , KC_C_5 , KC_C_6   , KC_EQUAL , KC_NO  , KC_NO ,     KC_NO , KC_NO     , KC_LSFT           , KC_RCTL              , KC_LALT          , KC_RGUI , KC_NO,
  KC_NO , KC_1   , KC_2   , KC_3     , KC_NO    , KC_NO  , KC_NO ,     KC_NO , KC_NO     , KC_RALT           , TD(TD_BOOT)          , TD(TD_EE_CLR)    , KC_NO   , KC_NO,
...
//    │   │       │       │  󰖁  │    │     │   │   │   │   │           │           │           │   │   │
//    ├───┼───────┼───────┼─────┼─────┼─────┼───┤   ├───┼───┼───────────┼───────────┼───────────┼───┼───┤
//    │   │  󰚱   │  󰚱 ↓  │ 󰚱 ↑ │ 󰚱  │     │   │   │   │   │ TD(def_󰄮) │ TD(def_) │ TD(def_) │   │   │
//    ├───┼───────┼───────┼─────┼─────┼─────┼───┤   ├───┼───┼───────────┼───────────┼───────────┼───┼───┤
//    │   │  ←/→ │  / │   │   │     │   │   │   │   │   LSFT    │           │           │   │   │
//    ├───┼───────┼───────┼─────┼─────┼─────┼───┤   ├───┼───┼───────────┼───────────┼───────────┼───┼───┤
//    │   │      │      │  ﱜ  │  ﱛ  │     │   │   │   │   │           │   TD(󰍛)   │   TD(󰘚)   │   │   │
...
//                                    └─────┴───┘   └───┴───┘                                            
  ...
  KC_NO , KC_PRNT_HPT , HF_DWLD , HF_DWLU  , HF_TOGG , KC_NO  , KC_NO ,     KC_NO , KC_NO     , TD(TD_DEF_L_BASE) , TD(TD_DEF_L_MEDIA) , TD(TD_DEF_L_MOUSE) , KC_NO , KC_NO,
  KC_NO , RGB_HUD     , RGB_VAD , RGB_MOD  , RGB_TOG , KC_NO  , KC_NO ,     KC_NO , KC_NO     , KC_LSFT           , KC_NO              , KC_NO              , KC_NO , KC_NO,
  KC_NO , KC_BRID     , KC_BRIU , KC_VOLD  , KC_VOLU , KC_NO  , KC_NO ,     KC_NO , KC_NO     , KC_NO             , TD(TD_BOOT)        , TD(TD_EE_CLR)      , KC_NO , KC_NO,
