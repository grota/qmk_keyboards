...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_5x7_sym(
     ...
     KC_NO,            KC_Z,     KC_T,    KC_M,              KC_V,   RALT_T(KC_SCOLON), TD_SQBRKTL,             TD_SQBRKTR, RALT_T(KC_COMMA),    KC_N,      KC_P,       KC_B,     KC_U,         KC_LGUI,
  ...
  [_FN_AND_MOUSE] = LAYOUT_5x7_sym(
   ...
   RGB_TOG,  AU_TOG, _______, TO(_BASE),                                                           TO(_BASE),     _______, _______, _______,
