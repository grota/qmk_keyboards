 ...
 * `--------+------+------+------+------+-------------'     `-------------+------+------+------+------+--------'
 *   | Ctrl | Win  | LAlt |Leader| Bksp |                               |Spc/LAlt|;/Ctrl|  '"  |  0)  |  9(  |
 *   `----------------------------------'                               `------------------------------------'
 *                                       ,-------------.   ,-------------.
 *                                       | BRI- | BRI+ |   | Vol- | Vol+ |
 *                                ,------|------|------|   |------+------+------.
...
[_BASE] = LAYOUT_ergodox_pretty(
  ...
  OSM(MOD_LSFT), KC_Z,  KC_T,  KC_M,  KC_B,  KC_V, TD(TD_SQBRKTL),  TD(TD_SQBRKTR), KC_SLASH, KC_N,    KC_P,    KC_DOT, KC_U,     RSFT_T(KC_EQUAL),

     KC_RCTRL, KC_LGUI, KC_LALT, KC_LEAD, KC_BSPACE,     LALT_T(KC_SPACE), LCTL_T(KC_SCOLON), KC_QUOTE, KC_0, KC_9,
